...
TOPIC_SESSION_STATUS_RESP: Literal["asol/session/status-resp"] = "asol/session/status-resp"
...
TOPIC_STREAM_STATUS_RESP: Literal["asol/stream/status-resp"] = "asol/stream/status-resp"
