...
proto.machine.SystemVialConfiguration = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.machine.SystemVialConfiguration.repeatedFields_, null);
};
 ...
 * @const
 */
proto.machine.SystemVialConfiguration.repeatedFields_ = [1];
...
proto.machine.SystemVialConfiguration.toObject = function(includeInstance, msg) {
  var f, obj = {
    vialsList: jspb.Message.toObjectList(msg.getVialsList(),
    proto.machine.VialProfile.toObject, includeInstance)
  };
...
proto.machine.SystemVialConfiguration.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.machine.VialProfile;
      reader.readMessage(value,proto.machine.VialProfile.deserializeBinaryFromReader);
      msg.addVials(value);
      break;
    default:
      reader.skipField();
...
proto.machine.SystemVialConfiguration.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getVialsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.machine.VialProfile.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated VialProfile vials = 1;
 * @return {!Array<!proto.machine.VialProfile>}
 */
proto.machine.SystemVialConfiguration.prototype.getVialsList = function() {
  return /** @type{!Array<!proto.machine.VialProfile>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.machine.VialProfile, 1));
};


/**
 * @param {!Array<!proto.machine.VialProfile>} value
 * @return {!proto.machine.SystemVialConfiguration} returns this
*/
proto.machine.SystemVialConfiguration.prototype.setVialsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.machine.VialProfile=} opt_value
 * @param {number=} opt_index
 * @return {!proto.machine.VialProfile}
 */
proto.machine.SystemVialConfiguration.prototype.addVials = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.machine.VialProfile, opt_index);
};
 ...
 * @return {!proto.machine.SystemVialConfiguration} returns this
 */
proto.machine.SystemVialConfiguration.prototype.clearVialsList = function() {
  return this.setVialsList([]);
};
