...
goog.exportSymbol('proto.machine.SessionContentStatuses', null, global);
 ...
 * @constructor
 */
proto.machine.SessionContentStatuses = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.machine.SessionContentStatuses.repeatedFields_, null);
};
goog.inherits(proto.machine.SessionContentStatuses, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.machine.SessionContentStatuses.displayName = 'proto.machine.SessionContentStatuses';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.machine.SessionContentStatuses.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.machine.SessionContentStatuses.prototype.toObject = function(opt_includeInstance) {
  return proto.machine.SessionContentStatuses.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.machine.SessionContentStatuses} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.machine.SessionContentStatuses.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.machine.SessionContentStatuses}
 */
proto.machine.SessionContentStatuses.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.machine.SessionContentStatuses;
  return proto.machine.SessionContentStatuses.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.machine.SessionContentStatuses} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.machine.SessionContentStatuses}
 */
proto.machine.SessionContentStatuses.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.machine.SessionContentStatuses.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.machine.SessionContentStatuses.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.machine.SessionContentStatuses} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.machine.SessionContentStatuses.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.machine.SessionContentStatuses.prototype.getContentStatusesList = function() {
 ...
 * @return {!proto.machine.SessionContentStatuses} returns this
*/
proto.machine.SessionContentStatuses.prototype.setContentStatusesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 */
proto.machine.SessionContentStatuses.prototype.addContentStatuses = function(opt_value, opt_index) {
 ...
 * @return {!proto.machine.SessionContentStatuses} returns this
 */
proto.machine.SessionContentStatuses.prototype.clearContentStatusesList = function() {
